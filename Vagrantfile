...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "./dist", "/opt/nomad/data/plugins", owner: "root", group: "root"
  config.vm.synced_folder "/Users/justin/tmp/ubuntu-firecracker/output", "/opt/nomad/img", owner: "root", group: "root"
